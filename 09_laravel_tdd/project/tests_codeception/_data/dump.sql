...
CREATE TABLE `categories` (
  ...
  CONSTRAINT `categories_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`)
...
INSERT INTO `categories` VALUES (1,'News','2021-01-22 14:00:24','2021-01-22 14:00:24',NULL),(2,'Opinion','2021-01-22 14:00:24','2021-01-22 14:00:24',NULL),(3,'Tutorial','2021-01-22 14:00:24','2021-01-22 14:00:24',NULL),(4,'Review','2021-01-22 14:00:24','2021-01-22 14:00:24',NULL);
...
CREATE TABLE `tags` (
  ...
  CONSTRAINT `tags_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'John Doe','john1111111.doe@gmail.com',NULL,'$2y$10$FGXc2r1nQyBkwnFS2q/A2.HavqpVfc8BerYrW9fHK8vWLaVIpWOR6',NULL,NULL,NULL,'mypage.com');
...
-- Dump completed on 2021-01-22 14:53:09
